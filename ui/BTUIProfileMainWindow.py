...
class Ui_ProfileMainWindow(object):
    def setupUi(self, ProfileMainWindow):
        ...
        self.actionSaveAs = QtWidgets.QAction(ProfileMainWindow)
        ...
        self.menuProfiles.addAction(self.actionSaveAs)
        self.menuProfiles.addSeparator()
    ...
    def retranslateUi(self, ProfileMainWindow):
        ...
        self.menuProfiles.setTitle(_translate("ProfileMainWindow", "Profiles"))
        ...
        self.actionSaveAs.setText(_translate("ProfileMainWindow", "Save As..."))
